...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="s:BatchSequence/s:Batch/s:Statements/*" mode="Statement">
    <div class="qp-statement-block">
      <div class="qp-statement-header-panel">
        <div class="qp-statement-header">
          <div class="qp-statement-query-panel">
            <div class="qp-query-tabs">
              <button type="button" class="qp-query-tab active" data-tab="resolved">Resolved Query</button>
              <button type="button" class="qp-query-tab" data-tab="real">Real Query</button>
              <button type="button" class="qp-query-tab qp-query-action qp-open-beautify">Beautify</button>
              <button type="button" class="qp-query-tab qp-query-action qp-copy-plan-xml">Copy Plan XML</button>
              <button type="button" class="qp-query-tab qp-query-action qp-open-xml-viewer">Show Plan XML</button>
              <button type="button" class="qp-query-tab qp-query-action qp-open-ai-assist">AI Assist</button>
            </div>
            <div class="qp-statement-header-row qp-query-pane active" data-pane="resolved">
              <div class="qp-resolved-query"></div>
            </div>
            <div class="qp-statement-header-row qp-query-pane" data-pane="real">
              <div class="qp-real-query"><xsl:value-of select="@StatementText" /></div>
            </div>
          </div>
          <div class="qp-missing-index-panel">
            <xsl:apply-templates select="s:QueryPlan/s:MissingIndexes/s:MissingIndexGroup" mode="MissingIndex" />
          </div>
        </div>
      </div>
      <div class="qp-diagram-panel">
        <div class="qp-diagram-canvas">
