...
export function KpiCards() {
  ...
  const showBufferHealth = activeTopicId === "tempdb_memory" || activeTopicId === "ple_trend";
  ...
  const loading = l0 || l1 || l2 || l3 || (showBufferHealth && l4);
  const refreshing = (f0 || f1 || f2 || f3 || (showBufferHealth && f4)) && !loading;
  const maxCount = Math.max(1, ...Object.values(counts));

  return (
    <div className={`relative grid grid-cols-2 gap-2 ${showBufferHealth ? "lg:grid-cols-4 xl:grid-cols-5" : "lg:grid-cols-4"}`}>
