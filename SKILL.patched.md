...
```powershell
Set-Location C:\Users\Admin\.codex\skills\ui-ux-pro-max
```
...
```powershell
python .\scripts\search.py "beauty spa wellness service elegant" --design-system -p "Serenity Spa"
```
...
```powershell
python .\scripts\search.py "layout responsive form" --stack html-tailwind
```
